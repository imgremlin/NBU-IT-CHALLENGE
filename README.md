...
* Hackathon from National Bank of Ukraine
* Task: Predict USD/UAH exchange rate, Time-Series
...
Choosing the columns that give the best result. We used our custom function based on **backward feature selection** to choose the most useful columns for modeling because the boosting model is sensitive to the columns in the dataset.
...
To confirm the hypothesis of the possibility of creating this feature, we will make an **autocorrelation plot** to see whether the time series lags correlate with each other because they will play a leading role in the future model.
